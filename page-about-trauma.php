  ...
  <div class="l-base c-white-box-l__wrapper">
    <article class="c-white-box-l">
      ...
      <p><b class="u-em-orange-marker">個人で対処できないほどの圧倒されるような体験によってもたらされる心の傷を「トラウマ」といいます。</b><br>
        ...
        広い意味では、いじめやハラスメントを受けた体験も指し、ストレスによって生じる傷つき全般をトラウマに含めることもあります。一方で、<b class="u-em-orange-marker">医学分野などでは、より狭い意味で使われることが多い</b>です。例えば、米国精神医学会による精神疾患の診断・統計マニュアル第5版（DSM-5）の基準によれば、心的外傷（＝トラウマ）を、<b class="u-em-orange-marker">「実際にまたは危うく死ぬ、深刻な怪我を負う、性的暴力など、精神的衝撃を受ける体験」と定義しています。</b></p>
    </article>
  </div>
