      ...
      <div class="p-tab-box__item active" data-targetTag="tag01">
        <section class="p-tab-box__inner">
          ...
          <div class="p-ttl-txt-box">
            ...
            <p>PTSDに対する主要な治療法には、心理療法に加え、薬物療法があります。国際的に影響力を持つ複数のPTSD治療ガイドラインでは、いずれもトラウマに焦点化した心理療法を第一推奨治療としていますが、そのうち一部のガイドラインは心理療法と並んで薬物療法を第一推奨に挙げています。PTSDへの薬物療法の適用について、日本トラウマティック・ストレス学会により以下の指針が示されています。<br>
          ...
          <div class="p-ttl-txt-box">
            ...
            <p>PTSDでは、ストレスへの反応を調整する脳の働きが変化している可能性が示されています。PTSDに保険適用のあるparoxetineとsertralineなどの選択的セロトニン再取り込み阻害薬（selective serotonin reuptake inhibitor: SSRI）、またvenlafaxineなどのセロトニン・ノルアドレナリン再取り込み阻害薬（serotonin noradrenaline reuptake inhibitor: SNRI）は、 <b class="u-em-orange-marker">神経伝達物質と呼ばれる脳内化学物質のバランスを調整することで、PTSDの症状を改善する</b>と考えられています。
            </p>
          </div>

          <div class="p-ttl-txt-box">
            <h2 class="p-ttl-txt-box__ttl">期待される効果</h2>
            <p>薬物療法開始にあたっては、薬剤を一剤選び、少量から服用を始めます。有害事象発現の有無を確認しつつ、投与可能な最大量まで増量します。服用を始めて約４〜６週間で良くなってくることが期待されますが、変化があらわれる期間には個人差があります。効果を持続させるためには、薬を飲み続ける必要があります。寛解後、維持療法として投与を1年間継続すると再発防止作用があることが報告されています。</p>
          </div>
