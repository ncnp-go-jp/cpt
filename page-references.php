    ...
    <article class="c-white-box-l">
      ...
      <div class="p-img-right-btm-box p-references__box">
        <div>
          ...
          <img src="<?php echo THEME_DIR_URI; ?>references/references-01.webp" alt="" class="p-img-right-btm-box__img -references">
      ...
      <div class="p-img-right-btm-box p-references__box">
        <div>
          ...
          <img src="<?php echo THEME_DIR_URI; ?>references/references-02.webp" alt="" class="p-img-right-btm-box__img -references">
      ...
      <div class="p-img-right-btm-box p-references__box">
        <div>
          ...
          <img src="<?php echo THEME_DIR_URI; ?>references/references-03.webp" alt="" class="p-img-right-btm-box__img -references">
      ...
      <div class="p-img-right-btm-box p-references__box">
        <div>
          ...
          <img src="<?php echo THEME_DIR_URI; ?>references/references-04.webp" alt="" class="p-img-right-btm-box__img -references">
      ...
      <div class="p-img-right-btm-box p-references__box">
        <div>
          ...
          <img src="<?php echo THEME_DIR_URI; ?>references/references-05.webp" alt="" class="p-img-right-btm-box__img -references">
