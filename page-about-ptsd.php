...
<article class="p-abt-trauma l-base" id="check">
  ...
  <div class="p-abt-trauma__txt-box">
    ...
    <p>下のボタンをクリックすると、PTSDの症状をチェックしてみることができます。通常では考えられないような、非常に恐ろしくて悲惨な出来事を経験した方が回答することで、PTSDに関して専門的な評価を受けた方がよい状態かを判断する目安になります（PTSDの診断をするものではありません）。</p>
  </div>
...
<article class="p-abt-trauma l-base">
  ...
  <div class="p-abt-trauma__txt-box">
    <p>上に挙げたようなPTSDの症状は、一時的には、トラウマを経験した人の多くに経験されるものです。しかし大抵は、時間が経つにつれて自然と症状が回復していきます。一方で、自然な回復が何らかの理由によって途中で阻まれてしまうと、一部の人はPTSDを発症し、時に長い期間、症状を抱えます。<br>
