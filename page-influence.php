      ...
      <div class="p-tab-box__item active" data-targetTag="tag01">
        <section class="p-tab-box__inner">
          ...
          <div class="p-tab-box__top-txt">
            <p>命にかかわるような重大な出来事に直面すると、しばしば、「闘争ー逃走ー凍結反応」と呼ばれる身体の反応が自動的に生じます。<b class="u-em-orange-marker">「危ない！」という信号を脳がキャッチすると、自分の身を守り、生き残る可能性を高めるために必要な準備を、身体が始める</b>のです。<br>
          ...
          <div class="p-tab-box__btm-txt -pickup">
            <p>出来事の最中に生じた上記のような反応は、その時の光景や音、においなどと結びついて記憶され、危機が去った後でも、トラウマや危険を知らせるアラームとして機能するようになることがあります。例えば、横断歩道を渡っているときに事故に遭った人が、事故後に横断歩道を見ると固まってしまう、といったことが起こります。<b class="u-em-orange-marker">危険を知らせるアラームが誤作動して、安全な場面でも、身体が反応してしまう</b>のです。<br>
              そうした誤作動は、通常は、時が経つにつれて弱まっていきます。<b class="u-em-orange-marker">アラームが鳴っても、自分の身に危険が及ばない経験を繰り返すことで、だんだんと、「もう安全なんだ」ということがわかってくる</b>ためです。一方で、出来事を思い出させるような手がかりを避けることで、誤作動に気づく機会を逃してしまい、何が危険で何が危険でないのか、正確に判断できないままになってしまいます。
            </p>
          </div>
