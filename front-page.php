    ...
    <section class="p-front-sec__item">
      ...
      <div class="p-front-sec__txt-box">
        <div>
          ...
          <p>心の傷に触れることや、一歩踏みだすには、勇気が要ります。<br class="u-pc">不安なときには、情報を集めることが役立ちます。<br class="u-pc">ご参考まで、科学的な根拠を示す記事や、さまざまな支援団体やその他の資源を示しました。</p>
        </div>
    ...
    <div class="p-front-info__box">
      ...
      <section class="p-front-info__item">
        ...
        <ul class="p-front-info__list">
          ...
          <li>動画教材：国立精神・神経医療研究センターで作成した解説動画。</li>
