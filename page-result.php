      ...
      <?php else: ?>
        ...
        <div class="p-img-right-btm-box">
          <div>
            ...
            <p>PTSD症状に大きく煩わされているのではないなら、何よりです。日々の暮らしの中で、自分を癒したり楽しませたりすることを大事にしながら、お過ごしいただければ幸いです。<br>人によっては、PTSD症状に波があります。普段は穏やかに過ごせていても、何かのきっかけで出来事を思い出したのをきっかけに、症状が強まる場合もあります。また、「記念日反応」と呼ばれる、出来事が起きた節目の時期に不調を感じる人もいます。<br>ご自分の心と体の状態に心を配り、もし不調のサインが出てきたら、またセルフチェックをしてみてください。</p>
          </div>
        </div>
        <div class="p-result__btn-box">
