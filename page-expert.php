...
<div class="u-bg-orange-gray">
  ...
  <div class="l-base c-white-box-l__wrapper">
    <article class="c-white-box-l">
      ...
      <p>認知処理療法に関心をお寄せいただき、ありがとうございます。<br>このページは、メンタルヘルスをサポートする臨床家のみなさまへ向けて、より専門的な情報をお伝えするために設けられています。<b class="u-em-orange-marker">CPTを使いこなすためには、心理支援に関する基本的な知識を持っていることと、心理支援専門職として人と関わるコミュニケーションの技術が必要</b>となります。しかし、これらの基礎をお持ちの方にとっては、CPTのプロトコルに習熟するための道のりは決して険しくはありません。ぜひ、CPTのアプローチを学んでいただき、日々、臨床で出会う方々に活用いただけたらと願っております。
      </p>
    </article>
  </div>
</div>
    ...
    <ul class="c-small-box-list">
      <li class="u-bg-orange-gray">
        ...
        <div class="c-small-box-list__txt-box">
          <p>CPT は各回のセッションで扱う内容が予め決められている、<b class="u-em-orange-marker">マニュアルベースの心理療法</b>です。一定の訓練を受けた臨床家が、マニュアルに則り実施することで、効果を発揮します。<br>ここでは、CPTの実施に必要なマニュアルを紹介しています。無料公開のものから、出版社で扱っている最新版まで、ニーズに応じてお手にとっていただければ幸いです。</p>
        </div>
      ...
      <li class="u-bg-orange-gray">
        ...
        <div class="c-small-box-list__txt-box">
          <p>国立精神・神経医療研究センターで作成した解説動画を公開しています。講義の中では、模擬事例を用いたセッションのロールプレイの様子も紹介しています。<br>CPTの全体像と実施のイメージを掴むためにご活用いただけますと幸いです。</p>
        </div>
      ...
      <li class="u-bd-beige">
        ...
        <div class="c-small-box-list__txt-box">
          <p>当サイトに掲載されている情報に関するお問い合わせは、下記のボタンをクリックし、お問い合わせフォームからお願いいたします。</p>
          <p>なお、トラウマやPTSDに係る相談・診療に関する内容は、原則として受付けておりません。お問い合わせいただいてもお答えしかねますので、予めご了承いただけますと幸いです。</p>
        </div>
        <a href="./contact/" class="c-btn">問い合わせをする　<i class="fas fa-angle-right"></i></a>
      </li>
    </ul>
