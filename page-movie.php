    ...
    <article class="c-white-box-l">
      ...
      <div class="p-movie-right-btm-box">
        <div>
          ...
          <h2 class="c-h3 p-tab-box__h2">　　３-３.　CPT全体の概要、治療前の準備と評価</h2>
          <p>CPTの治療の全体像を示したうえで、Session１から２で行われる心理教育と、スタックポイントの特定について解説します。CPTを導入するにあたり、考慮すべき対象者の特徴（物質乱用や、自殺念慮、解離等、治療に影響を与えると思われるもの）や治療導入のタイミングに係る考え方も紹介しています。<br>
            （講師：菊池安希子、時間：約38分）
          </p>
        </div>
      </div>
      ...
      <div class="p-movie-right-btm-box">
        <div>
          ...
          <h2 class="c-h3 p-tab-box__h2">４．スタックポイント、ABC用紙、考え直し用紙<br>
            　　４-１.　第２段階　スタックポイントを見つける</h2>
          <p>Session２の進め方を、デモ映像を含めて解説します。出来事の意味筆記を読み上げ、スタックポイントを同定するプロセスを紹介します。<br>
            （講師：牧野みゆき、時間：約23分）
          </p>
        </div>
      </div>
      ...
      <div class="p-movie-right-btm-box">
        <div>
          ...
          <h2 class="c-h3 p-tab-box__h2">　　４-２.　第２段階　ABC用紙</h2>
          <p>Session３の進め方を、デモ映像を含めて解説します。ABC用紙の位置付けや使い方、Sessionの中で患者が用紙に取り組むのを支援する方法を紹介します。<br>
            （講師：猪俣（佐藤）珠恵、時間：約18分）
          </p>
        </div>
      </div>
      ...
      <div class="p-movie-right-btm-box">
        <div>
          ...
          <h2 class="c-h3 p-tab-box__h2">　　４-３.　第３段階　インデックスイベントの処理</h2>
      ...
      <div class="p-movie-right-btm-box">
        <div>
          ...
          <h2 class="c-h3 p-tab-box__h2">　　４-４.　第４段階　考え直す力をつける</h2>
      ...
      <div class="p-movie-right-btm-box">
        <div>
          ...
          <h2 class="c-h3 p-tab-box__h2">５．５つのテーマ、再発予防<br>　　５-１. ５-２.　第５段階　５つのテーマ</h2>
          <p>Session８-１２の進め方を、デモ映像を含めて解説します。トラウマ体験により影響を受けやすい５つのテーマ（安全、信頼、力とコントロール、価値、親密さ）を１つ１つ取り上げ、それぞれの考え直しで焦点を当てる必要のあるポイントをを紹介します。また、研修の締めくくりのご挨拶を収録しています。<br>（講師：伊藤正哉、時間：①約37分、②約31分）
          </p>
        </div>
      </div>
      <div class="p-movie-right-btm-box">
...
<div id="modal03-1" class="p-modal">
  <div class="p-modal__inner -movie">
    <h3 class="p-modal__ttl">３-１. PTSDの機能モデル</h3>
...
<div id="modal03-2" class="p-modal">
  <div class="p-modal__inner -movie">
    <h3 class="p-modal__ttl">３-２. 社会認知理論</h3>
...
<div id="modal03-3" class="p-modal">
  <div class="p-modal__inner -movie">
    <h3 class="p-modal__ttl">３-３.　CPT全体の概要、治療前の準備と評価</h3>
...
<div id="modal04-1" class="p-modal">
  <div class="p-modal__inner -movie">
    <h3 class="p-modal__ttl">４-１.　第２段階　スタックポイントを見つける</h3>
...
<div id="modal04-2" class="p-modal">
  <div class="p-modal__inner -movie">
    <h3 class="p-modal__ttl">４-２.　第２段階　ABC用紙</h3>
    <video controls poster="<?php echo THEME_DIR_URI; ?>movie/movie-04-2b.webp">
...
<div id="modal04-3" class="p-modal">
  <div class="p-modal__inner -movie">
    <h3 class="p-modal__ttl">４-３.　第３段階　インデックスイベントの処理</h3>
...
<div id="modal04-4" class="p-modal">
  <div class="p-modal__inner -movie">
    <h3 class="p-modal__ttl">４-４.　第４段階　考え直す力をつける</h3>
...
<div id="modal05-1" class="p-modal">
  <div class="p-modal__inner -movie">
    <h3 class="p-modal__ttl">５-１. 第５段階　５つのテーマ</h3>
...
<div id="modal05-2" class="p-modal">
  <div class="p-modal__inner -movie">
    <h3 class="p-modal__ttl">５-２. 第５段階　５つのテーマ</h3>
