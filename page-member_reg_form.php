  ...
  <div class="l-base">
    ...
    <section class="p-reg__sec">
      ...
      <p>利用ページを利用するには、下記よりご登録いただけますようお願いいたします。<br>
        下記フォームに入力いただき、「登録」ボタンを押していただけましたら、入力されたメールアドレスに＊＊＊＊＊＊＊＊＊をお送りいたします。<br>
        なお、ご利用にあたっては、必ずお一人ずつのご登録をお願いいたします。</p>
      <p>※ご登録される情報の扱いは、当サイトの<a href="<?php echo home_url() . '/privacy'; ?>" target="_blank" class="u-orange-marker">プライバシーポリシー</a>をご確認ください。</p>
    </section>
    <section class="p-reg__sec">
