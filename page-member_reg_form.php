...
<div class="u-bg-orange-gray">
  ...
  <div class="l-base">
    ...
    <section class="p-reg__sec">
      ...
      <p>登録者ページを利用するには、下記よりご登録いただけますようお願いいたします。<br>
    ...
    <section class="p-reg__sec">
      <h2 class="">登録者ページでご覧いただける主な内容</h2>
      <p>
      <ul class="c-list u-bold">
        <li><span>・</span>パブリックドメインのCPTマニュアル：退役軍人／軍版に開発されたマニュアルと、CPTの進捗管理に役立つ資材。</li>
        <li><span>・</span>動画教材：国立精神・神経医療研究センターで過去に行った研修の動画。</li>
        <li><span>・</span>アセスメントツール：PCL-5（DSM-5のPTSD診断基準に準拠して作成された自己記入式尺度）</li>
      </ul>
      </p>
      <p>上記のほか、CPTを実施するにあたり参考となる情報をまとめています。なお、登録者ページに掲載している情報には、他サイト等でも公開しているものも含まれています。必ずしも当サイトの利用登録をしないと入手できないものばかりではないことをご承知おきください。</p>
      <p>掲載している情報は、心理支援に関する基本的な知識を持っている方を想定していますが、これから学んでいきたいとお考えの方にもご覧いただけたら幸いです。</p>
    </section>
    <?php if (have_posts()) : ?>
