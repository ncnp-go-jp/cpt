    ...
    <ul class="c-small-box-list">
      <li>
        ...
        <div class="c-small-box-list__txt-box">
          <p>治療によって、症状が治ったり軽くなったりする可能性があります。そして、症状により滞っていた日常生活や人間関係が、スムーズに運ぶようになる可能性もあります。これまでの研究から、トラウマに焦点を当てた心理療法と薬物療法の両方が、PTSDの治療に有効であることが示されています。</p>
        </div>
      ...
      <li>
        ...
        <div class="c-small-box-list__txt-box">
          <p>CPTは、全12回の各セッションの中で、どんなことに取り組むかが決まっている療法です。支援を求める人にとって、今、CPTに取り組むことが役立つかを見定めたうえで、決まった手順に則り実施することで、PTSDや関連する症状の改善に効果を発揮します。</p>
        </div>
      ...
      <li>
        ...
        <div class="c-small-box-list__txt-box">
          <p>CPTを活用したい・より詳しく知りたい方に向けた資料を紹介いたします。自分自身でCPTを理解するほか、PTSDやトラウマにお悩みの方への支援の一助としてもご活用いただけると幸いです。</p>
        </div>
